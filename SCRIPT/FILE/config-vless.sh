...
maxis="vless://${uuid}@104.20.44.247:$none?path=/xvlessntls&encryption=none&type=ws&host=speedtest.net.${domain}#${username}"
maxis2="vless://${uuid}@104.18.1.139:$none?path=/xvlessntls&encryption=none&type=ws&host=sub.viu.com.${domain}#${username}"
umobile="vless://${uuid}@www.mobilelegends.com.${domain}:$none?path=/xvlessntls&encryption=none&type=ws&host=new.mobilelegends.com#${username}"
...
echo -e "${cy}═════════════════════════════════════════════════════════════════${NC} "
echo -e "LINK TELCO DIGI YES TONEWOW :"
echo -e ""
echo -e "${YesDigiTone}"
echo -e ""
echo -e "${YesDigiTone1}"
echo -e ""
echo -e "${cy}═════════════════════════════════════════════════════════════════${NC} "
echo -e "LINK CELCOM BASIC & CELCOM 0 : "
echo -e ""
echo -e "${Celcom}"
echo -e ""
echo -e "${Celcom1}"
...
echo -e ""
echo -e "${cy}═════════════════════════════════════════════════════════════════${NC} "
echo -e "LINK UMOBILE ML , STRX & XLITE : "
echo -e ""
echo -e "${umobile}"
echo -e ""
echo -e "${Umobilestrx}"

...
echo -e  " ${cy}═════════════════════════════════════════════════════════════════${NC}"
echo -e  "            ${cy}PROTOCOL     ${wh}SSH/OVPN      VLESS${NC}    "
echo -e  "            ${cy}TOTAL USER${NC}      ${cy}[${NC}${wh}$usrovpn${NC}${cy}]${NC}       ${cy}[${NC}${wh}$usrvl${NC}${cy}]${NC}"
echo -e  " ${cy}═════════════════════════════════════════════════════════════════${NC}"
echo -e  "  ${cy}%-12s :${wh} %-15s ${cy}%-15s :${GREEN} %-10s${NC}\n" "RAM Usage" "$frem" "Total RAM" "$tram MB"
echo -e  "  ${cy}%-12s :${wh} %-30s${NC}\n" "SWAP Usage" "$freswp"
echo -e  "  ${cy}%-12s :${wh} %-30s${NC}\n" "CPU Usage" "$cpu"
echo -e  " ${cy}═════════════════════════════════════════════════════════════════${NC}"
echo -e  "  ${cy}%-12s :${BICyan} ${RED}%s${NC}|${BICyan} ${RED}%s${NC}|${BICyan} ${RED}%s${NC}\n" "Badwidth Use" "$ttoday" "$tyest" "$tmon"
echo -e  " ${cy}═════════════════════════════════════════════════════════════════${NC}"
